---
name: feedback-pattern-recognition
description: Search memory for patterns when receiving user corrections or criticism. Use when user corrects your behavior, expresses frustration, says they've told you before, or provides direct feedback about methodology.
---
...
1. Record feedback VERBATIM in session notes (importance: high)
2. Search me.md for existing instructions on this topic
3. Search patterns/ and concepts/ for related documented patterns
4. Search people/ for similar past corrections
5. Classify: First-time vs recurring vs instruction violation
6. Acknowledge pattern explicitly if found
7. Integrate into me.md if recurring (2+ occurrences)
